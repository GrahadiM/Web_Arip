...
- <code>git clone https://github.com/GrahadiM/Web_Arip.git</code>(from url github)
- <code>cd Laravel8_Covid-19</code>(your name project)
- <code>composer install</code> or <code>composer update</code>
- <code>cp .env.example .env</code> configuration your file .env in your project Laravel, change APP_NAME, DB_DATABASE, DB_USERNAME, DB_PASSWORD and DB_PORT
